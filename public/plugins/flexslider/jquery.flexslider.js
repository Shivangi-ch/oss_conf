...
(function ($) {
  ...
  $.thekeynote_flexslider = function(el, options) {
    var slider = $(el);

    // making variables public
    slider.vars = $.extend({}, $.thekeynote_flexslider.defaults, options);
    ...
    $.data(el, "thekeynote_flexslider", slider);
    ...
    methods = {
        ...
        setup: function() {
          ...
          if(!msGesture){
              slider.slides.click(function(e){
                ...
                } else if (!$(slider.vars.asNavFor).data('thekeynote_flexslider').animating && !$slide.hasClass(namespace + "active-slide")) {
              ...
              slider.slides.each(function (){
                  ...
                  that.addEventListener("MSGestureTap", function (e){
                      ...
                      var $slide = $(this),
                          target = $slide.index();
                      if (!$(slider.vars.asNavFor).data('thekeynote_flexslider').animating && !$slide.hasClass('active')) {
                          slider.direction = (slider.currentItem < target) ? "next" : "prev";
                          slider.flexAnimate(target, slider.vars.pauseOnAction, false, true, true);
                      }
                  });
      ...
      sync: function(action) {
        var $obj = $(slider.vars.sync).data("thekeynote_flexslider"),
    ...
    slider.flexAnimate = function(target, pause, override, withSync, fromNav) {
      ...
      if (!slider.animating && (slider.canAdvance(target, fromNav) || override) && slider.is(":visible")) {
        if (asNav && withSync) {
          var master = $(slider.vars.asNavFor).data('thekeynote_flexslider');
  ...
  $.thekeynote_flexslider.defaults = {
  ...
  $.fn.thekeynote_flexslider = function(options) {
    ...
    if (typeof options === "object") {
      ...
      if ( ( $slides.length === 1 && options.allowOneSlide === true ) || $slides.length === 0 ) {
        ...
        } else if ($this.data('thekeynote_flexslider') === undefined) {
          new $.thekeynote_flexslider(this, options);
        }
      });
    } else {
      // Helper strings to quickly perform functions on the slider
      var $slider = $(this).data('thekeynote_flexslider');
      switch (options) {
