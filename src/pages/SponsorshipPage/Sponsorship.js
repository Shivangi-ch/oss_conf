...
<div class="boxes">
    <ol class="gradient-list">
        <li class="box">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</li>
        <li class="box">Aenean tincidunt elit at ipsum cursus, vitae interdum nulla suscipit.</li>
        <li class="box">Curabitur in orci vel risus facilisis accumsan.</li>
        <li class="box">Morbi eleifend tortor lacinia sapien sagittis, quis pellentesque felis egestas.</li>
        <li class="box">Aenean viverra dui quis leo lacinia fringilla.</li>
        <li class="box">Sed varius lectus ac condimentum egestas.</li>
        <li class="box">Maecenas faucibus lorem nec lorem posuere, a rhoncus velit porttitor.</li>
        <li class="box">Proin porta arcu ac elit malesuada pulvinar.</li>
        <li class="box">Suspendisse consectetur nibh non condimentum porta.</li>
        <li class="box">Ut placerat diam in cursus aliquet.</li>
        <li class="box">Praesent vitae quam id tortor malesuada viverra ut at elit.</li>
      </ol>
</div>
</p>
<p class="text">
